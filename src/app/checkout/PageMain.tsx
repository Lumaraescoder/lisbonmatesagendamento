    ...
    const listingId = searchParams.get("listingId") || searchParams.get("listing");
      ...
      if (listingId) {
        ...
        if (found) {
          ...
          setListingSubtitle(found.author?.displayName || found.author?.name || null);
        ...
        <div>
          ...
          {!submitted ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                <Label>Country *</Label>
                <Input type="text" name="country" placeholder="Portugal" required />
              </div>
              <div className="space-y-1">
                <Label>City *</Label>
                <Input type="text" name="city" placeholder="Lisbon" required />
              </div>
            </div>

            <div className="space-y-1">
              <Label>Hotel or pickup point (you can choose later) *</Label>
              <Input type="text" name="pickup_point" placeholder="Address or hotel name" required />
            </div>

            <div className="space-y-1">
              <Label>Trip details *</Label>
              <Textarea name="trip_details" placeholder="Any detail or special request for your trip?" required />
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4">
                <ButtonPrimary href="/pay-done" className="w-full md:w-auto bg-yellow-500 hover:bg-yellow-600 text-white px-8 py-3 rounded-xl font-medium">
                  Pay with PayPal
                </ButtonPrimary>
              </div>
            </div>
